...
public class GameCompletion extends JPanel{
    ...
    public void paint(Graphics gIn){
        ...
        if(creditsDone == false){ //As long as there are still credits to go
            if(p1.y <= 150){ //The top credit has hit the top of the screen! Oh no!
                ...
                if(credits.size() <= index){ //Make sure we stop pulling elements when we've got no more!
